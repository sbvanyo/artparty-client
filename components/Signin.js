...
function Signin() {
  return (
    <div id="login-screen">
      <Image id="logo" src="https://firebasestorage.googleapis.com/v0/b/artparty-fb1dd.appspot.com/o/images%2Fartparty.JPG?alt=media&token=6b243006-082e-4356-bf77-67a1f9bfbd03" />
      <div id="login-msg">
        <h1>ART PARTY!</h1>
